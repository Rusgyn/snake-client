...
- Access the README file and follow the steps inside the snk server repo to run the server side.
...
- When idled, a message pop up ("Server says:  you crashed, so you ded")
- When bumped or hit the wall, a message pop up (Server says:  you crashed, so you ded.). Ctrl + C are the only keys that quit your connection.
